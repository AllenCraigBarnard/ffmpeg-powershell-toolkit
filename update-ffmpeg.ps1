...
- Delete existing ffmpeg and all it's contents folder from your user profile home directory.
...
.\update-ffmpeg.ps1 -iAgreeAndAcknowledgeRisks 
...
Remove-Item -Recurse $detinationPath
